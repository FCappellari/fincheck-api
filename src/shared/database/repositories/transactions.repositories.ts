...
export class TransactionsRepository {
  ...
  findMany(findManyData: Prisma.TransactionFindManyArgs) {
    return this.prismaService.transaction.findMany(findManyData);
  }

  findFirst(findFirstData: Prisma.TransactionFindFirstArgs) {
    return this.prismaService.transaction.findFirst(findFirstData);
  }
